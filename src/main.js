...
function render() {
  ...
  document.querySelector('#app').innerHTML = `
    <header class="site-header">
      ...
      <div class="header-actions"><a class="text-link" href="https://github.com/TKGEKKOU/charactoid-product-site#readme" target="_blank" rel="noreferrer">开发者文档 ${icons.arrow}</a><a class="button button-primary button-small" href="https://github.com/TKGEKKOU/charactoid-product-site" target="_blank" rel="noreferrer">查看GitHub ${icons.arrow}</a></div>
      <button class="mobile-menu" aria-label="打开菜单">${icons.menu}</button>
    </header>
    <div class="mobile-drawer" aria-hidden="true"><button class="drawer-close" aria-label="关闭菜单">${icons.close}</button><a href="#capabilities">项目定位</a><a href="#architecture">工作方式</a><a href="#workflow">真实案例</a><a href="#workers">能力单元</a><a href="#ecosystem">资源与扩展</a><a href="#boundaries">运行边界</a><a href="https://github.com/TKGEKKOU/charactoid-product-site#readme" target="_blank" rel="noreferrer">开发者文档 ${icons.arrow}</a><a href="https://github.com/TKGEKKOU/charactoid-product-site" target="_blank" rel="noreferrer">查看GitHub ${icons.arrow}</a></div>
    <main>
