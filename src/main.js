...
function render() {
  ...
  document.querySelector('#app').innerHTML = `
    ...
    <main>
      ...
      <section class="closing section-pad" id="closing"><div class="closing-inner reveal"><span class="closing-orbit orbit-a"></span><span class="closing-orbit orbit-b"></span><p class="eyebrow"><span class="eyebrow-dot"></span> 从一次真实请求开始</p><h2>开始建立角色，<br /><em>也建立它行动的方式。</em></h2><p>为不同角色配置知识、声音、形象与能力，再从一句真实请求开始。</p><div class="hero-actions"><a class="button button-dark" href="https://github.com/TKGEKKOU/yumeno#快速开始" target="_blank" rel="noreferrer">快速开始 ${icons.arrow}</a><a class="button button-outline-white" href="https://github.com/TKGEKKOU/yumeno" target="_blank" rel="noreferrer">查看源码</a></div></div></section>
    </main>
    <footer class="site-footer"><div class="footer-brand"><img class="footer-logo" src="/assets/brand/48.ico" alt="" /><div><strong>CHARACTOID</strong><span>开源角色 Agent 工作台</span></div></div><div class="footer-links"><a href="#capabilities">项目定位</a><a href="#architecture">工作方式</a><a href="#workflow">真实案例</a><a href="#workers">能力单元</a><a href="#ecosystem">资源与扩展</a><a href="#boundaries">运行边界</a><a href="https://github.com/TKGEKKOU/yumeno" target="_blank" rel="noreferrer">GitHub ${icons.arrow}</a></div><div class="footer-bottom"><span>Local-first. Role-driven. Resumable.</span><span>MIT LICENSE / 2026</span></div></footer>`;
  bindEvents();
}
