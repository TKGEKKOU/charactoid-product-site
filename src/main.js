...
function render() {
  ...
  document.querySelector('#app').innerHTML = `
    <header class="site-header">
      ...
      <div class="header-actions"><a class="button button-primary button-small" href="https://github.com/TKGEKKOU/charactoid-product-site#readme" target="_blank" rel="noreferrer">开发者文档 ${icons.arrow}</a><a class="text-link" href="https://github.com/TKGEKKOU/charactoid-product-site" target="_blank" rel="noreferrer">查看GitHub ${icons.arrow}</a></div>
